...
document.addEventListener('DOMContentLoaded', function(event){
    ...
    function createHeroCard(hero) {
        ...
        let content = `
            ...
            <p><strong>Подробнее:</strong> ${hero.info}</p>
            <div class="rating">
                <p id="rating-${hero.name}">Выберите оценку для ${hero.name}:</p>
        ...
        allStars.forEach((star, i) => {
            star.onclick = function() {
                ...
                // Сохранение оценки в Local Storage
                localStorage.setItem(`rating-${hero.name}`, currentStarLevel);
            }
        });

        // Загрузка сохраненной оценки из localStorage
        const savedRating = localStorage.getItem(`rating-${hero.name}`);
        if (savedRating) {
